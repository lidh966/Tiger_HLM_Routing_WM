 ...
 * with the signature:
 *
 *   float rule_<res_id>(float inflow_m3day, float storage_m3, int month);
 *
 ...
 * @param inflow_m3day  Total inflow to the reservoir at this time step (m³/day).
 ...
 */
float applyReservoirRule(int res_id, float inflow_m3day, float storage_m3, int month);
